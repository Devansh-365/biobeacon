...
const WelcomeEmail = ({ name }: WelcomeEmailProps) => {
  const previewText = `–An Open-Source Solution for Streamlining Your Social Media Links`;
        ...
        <Body className="bg-white my-auto mx-auto font-sans">
          <Container className="my-10 mx-auto p-5 w-[465px]">
            <Heading className="text-2xl font-normal text-center p-0 mt-4 mb-8 mx-0">
              Welcome to{" "}
              <span className="font-bold tracking-tighter">BioBeacon</span>
            </Heading>
            <Text className="text-sm">
              Thanks for signing up{name && `, ${name}`}!
            </Text>
            <Text className="text-sm">
              My name is Devansh, and I&apos;m the creator of BioBeacon –An
              Open-Source Solution for Streamlining Your Social Media Links!
            ...
            <Text className="text-sm">
              <ul className="list-disc list-inside text-sm">
                ...
                <li>Customize and Add Social Links</li>
